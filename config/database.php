    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_CLASS_HOST', 'localhost'),
            'port' => env('DB_CLASS_PORT', '1433'),
            'database' => env('DB_CLASS_DATABASE', 'forge'),
            'username' => env('DB_CLASS_USERNAME', 'forge'),
            'password' => env('DB_CLASS_PASSWORD', ''),
            'charset' => 'UTF-8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
